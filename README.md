...
Hook used to get the route, or current path.
1. How would you explain form validation to someone who has never programmed before?
Form validation is using a third party program to make certain forms maintain certain qualities before being submitted.
